...
export class SearchComponent implements OnInit, AfterViewInit{
  ...
  constructor(private fb: FormBuilder, private router: Router, private routeSearchSvc: RouteSearchService) {}
  ...
  ngAfterViewInit() {
    this.originAutocompleter = new google.maps.places.Autocomplete(this.originAutocompleteInput.nativeElement);
    this.destinationAutocompleter = new google.maps.places.Autocomplete(this.destinationAutocompleteInput.nativeElement);
  ...
  submitForm() {
    this.router.navigate(['routes/results'],{queryParams:
                                                {origin: this.originPlace.place_id,
                                                 ...
                                                 time: this.routeSearchSvc.createISOString(this.searchForm.get('date')?.value, this.searchForm.get('time')?.value),
